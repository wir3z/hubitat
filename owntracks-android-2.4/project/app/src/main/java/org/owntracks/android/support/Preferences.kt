...
class Preferences @Inject constructor(
    ...
    fun getDeviceId(fallbackToDefault: Boolean): String {
        val deviceId = getStringOrDefault(R.string.preferenceKeyDeviceId, R.string.valDeviceId)
    ...
    var url: String
        get() = getStringOrDefault(R.string.preferenceKeyURL, R.string.valUrl)
        set(url) {
    ...
    var remoteConfiguration: Boolean
        get() = getBooleanOrDefault(R.string.preferenceKeyRemoteConfiguration, R.bool.valTrue)
        set(newValue) {
