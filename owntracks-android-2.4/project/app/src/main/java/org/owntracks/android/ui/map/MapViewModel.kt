...
class MapViewModel @Inject constructor(
    ...
    fun currentContactgetAppPermissions(): String? {
        return mutableCurrentContact.value?.getAppPermissions()
    }

    fun currentContactgetWifiEnabledDisabled(): String? {
        return mutableCurrentContact.value?.getWifiEnabledDisabled()
    }
